...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="/assets/AdminLTE/dist/img/logokoperasi.png" alt="Logo_Koperasi" height="100" width="100">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="/assets/AdminLTE/dist/img/logokoperasi.png" alt="Logo_Koperasi" class="brand-image img-circle elevation-3" style="opacity: .8">
